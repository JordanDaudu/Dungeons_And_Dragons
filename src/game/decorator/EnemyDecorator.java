...
//        if(decoratedEnemy instanceof MagicAttacker magicAttacker)
...
//        if(decoratedEnemy instanceof MagicAttacker magicAttacker)
//            magicAttacker.castSpell(target);
//    }
//
//    @Override
//    public MagicElement getElement() {
//        if(decoratedEnemy instanceof MagicAttacker magicAttacker)
//            return magicAttacker.getElement();
//        else
//            return null;
//    }
//
...
//        if(decoratedEnemy instanceof MagicAttacker magicAttacker)
//            return magicAttacker.isElementStrongerThan(other);
//        else
//            return false;
//    }
//
...
//        if(decoratedEnemy instanceof MeleeFighter meleeFighter)
//            meleeFighter.fightClose(target);
//    }
//
//    @Override
//    public boolean isInMeleeRange(Position self, Position target) {
//        if(decoratedEnemy instanceof MeleeFighter meleeFighter)
//            return meleeFighter.isInMeleeRange(self, target);
//        else
//            return false;
//    }
//
...
//        if(decoratedEnemy instanceof PhysicalAttacker physicalAttacker)
//            return physicalAttacker.calculateDamage(target);
//        else
//            return 0;
//    }
//
...
//        if(decoratedEnemy instanceof PhysicalAttacker physicalAttacker)
//            physicalAttacker.attack(target);
//    }
//
//    @Override
//    public boolean isCriticalHit() {
//        if(decoratedEnemy instanceof PhysicalAttacker physicalAttacker)
//            return physicalAttacker.isCriticalHit();
//        else
//            return false;
//    }
//
...
//        if(decoratedEnemy instanceof RangedFighter rangedFighter)
//            rangedFighter.fightRanged(target);
//    }
//
//    @Override
//    public int getRange() {
//        if(decoratedEnemy instanceof RangedFighter rangedFighter)
//            return rangedFighter.getRange();
//        else
//            return 0;
//    }
//
...
//        if(decoratedEnemy instanceof RangedFighter rangedFighter)
//            return rangedFighter.isInRange(self, target);
//        else
//            return false;
//    }
